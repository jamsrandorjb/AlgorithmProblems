...
public class WordLadder2 {
    ...
    public static List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        if(!hSet.contains(endWord)) return result;
        ...
        for(List<String> list : result) {
        	if(list.size() == minPath[0]) resultReal.add(list);
        }
        
        return resultReal;
    }
    private static void dfs(String beginWord, String endWord, HashSet<String> wordSet, List<List<String>> result, HashSet<String> tempResult, int[] minPath){
